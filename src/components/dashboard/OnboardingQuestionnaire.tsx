...
const OnboardingQuestionnaire: React.FC<OnboardingQuestionnaireProps> = ({ 
  ...
  const aiExposureLevels = [
    ...
    { value: 'minimal', label: 'Minimal - Watched YouTube videos or followed AI-related news' },
    { value: 'moderate', label: 'Moderate - Attended webinars, CMEs, or read articles about AI in medicine' },
    { value: 'high', label: 'High - Completed formal course (>10 hours) or contributed to AI-based project' }
  ];
      ...
      <Card>
        <CardHeader className="px-4 md:px-6 py-6">
          ...
          <p className="text-center text-muted-foreground text-sm md:text-base mt-3 leading-relaxed">
            Please provide the following information to help us understand your background and tailor your experience.
          </p>
        </CardHeader>
          ...
          <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6 md:space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-muted-foreground">
                Please answer the following questions to assess your baseline knowledge of AI in healthcare.
              </p>

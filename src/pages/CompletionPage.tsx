			...
			<div className="max-w-lg w-full space-y-8 bg-background z-10 p-8 rounded-xl border border-border">
				<div className="text-center">
					...
					<p className="mt-2 text-lg text-muted-foreground">
						You have successfully completed the study. Your responses have been
					...
					<CardContent className="py-8 px-6">
						<div className="text-center space-y-4">
							<p className="text-foreground">
								We appreciate your time and valuable feedback. Your
								participation helps us improve our understanding of user
